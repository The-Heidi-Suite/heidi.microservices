# HEIDI Web Platform Requirements
...
| ------------------------------------------------------------ | ------------------------------------------------------------------- |
| [CMS Requirements](./cms.requirement.md)                     | Detailed Web CMS features, flows, and screen specifications         |
| [Citizen Web App Requirements](./citizen-web.requirement.md) | Detailed Citizen Web App features, flows, and screen specifications |
